...
input_file = "../../../globus/olcf/run7_mhd_on_N7/pink.nek5000"
output_file = input_file.replace("pink.nek5000", "pink_resampled_x400.pvti")
...
resample.SamplingDimensions = [1446, 400, 744]
